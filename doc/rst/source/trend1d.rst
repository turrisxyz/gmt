...
**-W**\ [**+s**]
    ...
    and create weights as :math:`1/\sigma^2` [Default reads only the first 2 columns].
...
To fit the model :math:`y(x) = a + b x^2 + c \cos(2\pi 3 x/L) + d \sin(2\pi 3 x/L)`,
with :math:`L` the fundamental period (here :math:`L = 15`), try:
