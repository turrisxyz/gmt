...
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **AREA**      | 0 1   | Area of each gridnode cell (in km:math:`^2` if geographic)                                             |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **ASEC**      | 1 1   | asec (A)                                                                                               |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **ASIN**      | 1 1   | asin (A)                                                                                               |
...
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **D2DX2**     | 1 1   | :math:`\partial^2 A/\partial x^2` 2nd derivative                                                       |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **D2DY2**     | 1 1   | :math:`\partial^2 A/\partial y^2` 2nd derivative                                                       |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
| **D2DXY**     | 1 1   | :math:`\partial^2 A/(\partial x \partial y)` 2nd derivative                                            |
+---------------+-------+--------------------------------------------------------------------------------------------------------+
...
#. All functions expecting a positive radius (e.g., **LOG**, **KEI**,
   ...
   **BITTEST**, and **BITXOR**) convert a grid's single precision values to
   ...
   :math:`2^24 = 16,777,216`. Any higher result will be masked to fit in the lower
